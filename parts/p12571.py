...
class MappersList:
    ...
    def _render(self, appearance_time: list, end_time: int, font: str, size: int):
        ...
        for i, (mapper, appear_time) in enumerate(zip(self._mappers_list, appearance_time)):
            ...
            scroll_up = 2 * (i % 2) - 1
            initial_actions = [Move(0, appear_time, appear_time, (SB_DEFAULT_X // 2, SB_DEFAULT_Y // 2), (SB_DEFAULT_X // 2, SB_DEFAULT_Y // 2)), Fade(0, appear_time - 1, appear_time, 0, 1), Fade(0, end_time, end_time + 1, 1, 0)]

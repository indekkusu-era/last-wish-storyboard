...
class Part:
    ...
    def render(self):
        glitch_mapper_name = VocalText(self.mapper_name, 20, 'resources/NewRocker-Regular.ttf', 5)
        glitch_spell_card = VocalText(self.card_name, 15, 'resources/NewRocker-Regular.ttf', 5)
